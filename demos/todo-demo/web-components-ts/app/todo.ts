///<reference path="../../../../src/ihjs/build/1.2.2/types/components.d.ts"/>
...
export default class {
    ...
    createNewToDoItem() {
        this.model.content.append(String.html`<todo-item data-index="${increase()}">${this.model.input.value}</todo-item>`.dom())
    }
};
